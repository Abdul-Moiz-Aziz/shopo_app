...
const TermsConditions = () => {
  return (
    <div className="mb-10 w-full">
      ...
      <div className="w-full px-2 md:pt-10 pt-5 md:px-6 xl:px-[75px]">
        <div>
          <p className="my-[15px]  text-[15px] leading-[30px] text-[#797979]">
            Welcome to <span className="bg-yellow-100">Website Name</span>!
          </p>

          <p className="my-[15px]  text-[15px] leading-[30px] text-[#797979]">
            These terms and conditions outline the rules and regulations for the
            use of <span className="bg-yellow-100">Company Name</span>'s
            Website, located at{" "}
            <span className="bg-yellow-100">Website.com</span>.
          </p>

          <p className="my-[15px]  text-[15px] leading-[30px] text-[#797979]">
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use{" "}
            <span className="bg-yellow-100">Website Name</span> if you do not
          ...
          <h3 className="my-[15px]  text-[15px] leading-[30px] font-semibold text-[#797979]">
            Cookies
          </h3>

          <p className="my-[15px]  text-[15px] leading-[30px] text-[#797979]">
            We employ the use of cookies. By accessing{" "}
            <span className="bg-yellow-100">Website Name</span>, you agreed to
            use cookies in agreement with the{" "}
            <span className="bg-yellow-100">Company Name</span>'s Privacy
            Policy.
          </p>
          ...
          <p className="my-[15px]  text-[15px] leading-[30px] text-[#797979]">
            ...
            <span className="bg-yellow-100">Company Name</span> and/or its
            licensors own the intellectual property rights for all material on{" "}
            <span className="bg-yellow-100">Website Name</span>. All
            intellectual property rights are reserved. You may access this from{" "}
            <span className="bg-yellow-100">Website Name</span> for your own
            personal use subjected to restrictions set in these terms and
            conditions.
          </p>
          <ul className="my-[15px] list-outside list-disc space-y-2 pl-5  text-[15px] leading-[30px] text-[#797979]">
            <li className="my-[15px]">
              Republish material from{" "}
              <span className="bg-yellow-100">Website Name</span>
            </li>
            <li className="my-[15px]">
          ...
          <p className="my-[15px]  text-[15px] leading-[30px] text-[#797979]">
            ...
            <span className="bg-yellow-100">Company Name</span> does not filter,
            edit, publish or review Comments prior to their presence on the
            website. Comments do not reflect the views and opinions of{" "}
            <span className="bg-yellow-100">Company Name</span>, its agents
            ...
            applicable laws, <span className="bg-yellow-100">Company Name</span>{" "}
          ...
          <p className="my-[15px]  text-[15px] leading-[30px] text-[#797979]">
            <span className="bg-yellow-100">Company Name</span> reserves the
          ...
          <p className="my-[15px]  text-[15px] leading-[30px] text-[#797979]">
            You hereby grant <span className="bg-yellow-100">Company Name</span>{" "}
          ...
          <ul className="my-[15px] list-outside list-disc space-y-2 pl-5  text-[15px] leading-[30px] text-[#797979]">
            <li className="my-[15px]">Government agencies;</li>
            <li className="my-[15px]">Search engines;</li>
            <li className="my-[15px]">News organizations;</li>
            <li className="my-[15px]">
          ...
          <ul className="my-[15px] list-outside list-disc space-y-2 pl-5  text-[15px] leading-[30px] text-[#797979]">
            ...
            <li className="my-[15px]">dot.com community sites;</li>
            <li className="my-[15px]">
              associations or other groups representing charities;
            </li>
            <li className="my-[15px]">online directory distributors;</li>
            <li className="my-[15px]">internet portals;</li>
            <li className="my-[15px]">accounting, law and consulting firms;</li>
            <li className="my-[15px]">
          ...
          <p className="my-[15px]  text-[15px] leading-[30px] text-[#797979]">
            ...
            <span className="bg-yellow-100">Company Name</span>; and (d) the
          ...
          <p className="my-[15px]  text-[15px] leading-[30px] text-[#797979]">
            ...
            <span className="bg-yellow-100">Company Name</span>. Please include
          ...
          <ul className="my-[15px] list-outside list-disc space-y-2 pl-5  text-[15px] leading-[30px] text-[#797979]">
            <li className="my-[15px]">By use of our corporate name; or</li>
            <li className="my-[15px]">
          ...
          <p className="my-[15px]  text-[15px] leading-[30px] text-[#797979]">
            No use of <span className="bg-yellow-100">Company Name</span>'s logo
            or other artwork will be allowed for linking absent a trademark
            license agreement.
          </p>

          <h3 className="my-[15px]  text-[26px] font-semibold text-[#797979]">
            iFrames
          </h3>
